...
public class calculatorTest {
	...
	public void testGenerateAdd() {
		String[] output = calculator.generate(2, new int[]{1, 10}, new Operator[]{Operator.ADD});
	...
	public void testGenerateSub() {
		String[] output = calculator.generate(2, new int[]{1, 10}, new Operator[]{Operator.SUB});
		assertTrue(contains(output[0],'-'));
	...
	public void testGenerateDiv() {
		String[] output = calculator.generate(2, new int[]{1, 10}, new Operator[]{Operator.DIV});
		assertTrue(contains(output[0],'/'));
	...
	public void testGenerateMul() {
		String[] output = calculator.generate(2, new int[]{1, 10}, new Operator[]{Operator.MUL});
		assertTrue(contains(output[0],'*'));
	...
	public void testGenerateExp() {
		String[] output = calculator.generate(2, new int[]{1, 10}, new Operator[]{Operator.EXP});
		assertTrue(contains(output[0],'^'));
	...
	public void testCorrectSortingPositive() {
		...
		calculator.generate(2, new int[]{10, 2}, new Operator[]{Operator.ADD});
	}
	...
	public void testCorrectSortingNegativ() {
		exceptionRule.expect(IllegalArgumentException.class);
	    exceptionRule.expectMessage("The real interval has to in the format [smaller, bigger]!");
		calculator.generate(2, new int[]{-2, -6}, new Operator[]{Operator.ADD});
	}
	...
	public void testCorrectSortingBoth() {
		exceptionRule.expect(IllegalArgumentException.class);
	    exceptionRule.expectMessage("The real interval has to in the format [smaller, bigger]!");
		calculator.generate(2, new int[]{10, -6}, new Operator[]{Operator.ADD});
	}
	...
	public void testNoNegativTermNumber() {
		...
		calculator.generate(-1, new int[]{2, 6}, new Operator[]{Operator.ADD});
	}
