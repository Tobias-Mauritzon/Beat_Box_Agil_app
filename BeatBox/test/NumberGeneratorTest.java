...
public class NumberGeneratorTest {
	...
	public void testGenerateAdd() {
		numG.setSettings(new ProblemParameters(new ArrayList<Operator>() {
			{
				add(Operator.ADD);
			}
		}, new int[] { 1, 10 }, 2, false));
	...
	/**
	 * Test that number range in form bigger, smaller throws error, with positive
	 * numbers
	 */
	@Test
	...
	/**
	 * Test that number range in form bigger, smaller throws error, with negative
	 * numbers
	 */
	@Test
	...
	/**
	 * Test that unique generation happens when parameters allow at least 11
	 * different problems
	 */
	@Test
	...
	/**
	 * Test that unique generation does not happen when parameters don't allow for
	 * at least 11 different problems
	 */
	@Test
